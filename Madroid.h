...
class Madroid : public IOEthernetController {
	OSDeclareDefaultStructors(Madroid);	// Constructor & Destructor stuff
...
class MadroidUSBInterface : public Madroid {
	OSDeclareDefaultStructors(MadroidUSBInterface);
public:
	virtual bool start(IOService *provider);
};

class MadroidInterface : public IOEthernetInterface {
	OSDeclareDefaultStructors(MadroidInterface);
	int maxmtu;
public:
